  ...
  return (
    <div className="border-b border-[#e8e8e8] py-8">
      <div className="container container-7xl mx-auto lg:px-0 px-4">
        <h2 className="font-rubik lg:text-[32px] text-2xl font-semibold text-secondary leading-[100%]">
          Saving to celebrate
        </h2>
        <p className="mt-2 text-secondary/90 font-open-sans text-sm leading-[150%]">
          Enjoy up to 60% off thousands of styles during the End of Year sale - while supplies last. No code needed.
        </p>
        <p className="text-secondary font-open-sans text-sm leading-[150%] pt-2 font-semibold">
