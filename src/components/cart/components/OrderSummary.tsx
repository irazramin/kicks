...
export function OrderSummary({
  ...
  return (
    <div className="rounded-[16px] lg:bg-transparent bg-white lg:p-0 p-4">
      <h2 className="font-rubik lg:text-[32px] text-xl font-semibold text-[#232321] leading-[100%]">
        Order Summary
      </h2>
      <ul className="mt-6 space-y-4 list-none">
        <li className="flex justify-between text-[#232321]">
      ...
      <Link
        href="/checkout"
        className="mt-6 block w-full rounded-lg bg-[#232321] py-4 text-center text-sm font-medium uppercase tracking-wide text-white transition-colors hover:bg-[#333]"
      >
        Checkout
      </Link>
      <Link
        href="#promo"
        className="lg:mt-6 mt-4 block text-start lg:text-xl text-base font-open-sans leading-[100%] font-semibold text-[#232321] underline hover:no-underline"
      >
        Use a promo code
      </Link>
    </div>
