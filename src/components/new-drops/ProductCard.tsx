...
export function ProductCard({
  ...
  return (
    ...
    >
      <div className="relative flex-1 p-2 bg-white max-h-[350px] h-full rounded-[24px]">
      ...
      <div className="text-start">
        <h3 className="font-semibold text-[#232321] line-clamp-2 text-2xl leading-[100%] font-rubik py-4">
          {title}
        </h3>
        <button type="button" className="block w-full rounded-[8px] bg-[#232321] px-4 py-4 text-center text-sm font-medium text-white font-rubik">
